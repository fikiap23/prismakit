...
| `prismakit/require-cached-repo-provider` | Cached `defineAppRepo({ cache })` classes must be in a Nest `providers` array (flags the repo class **and** the feature module) |
